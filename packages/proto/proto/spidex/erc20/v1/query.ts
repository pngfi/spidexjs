 ...
 * source: spidex/erc20/v1/query.proto
...
export namespace spidex.erc20.v1 {
    ...
    export class QueryTokenPairsResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            token_pairs?: dependency_3.spidex.erc20.v1.TokenPair[];
        ...
        get token_pairs() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_3.spidex.erc20.v1.TokenPair, 1) as dependency_3.spidex.erc20.v1.TokenPair[];
        }
        set token_pairs(value: dependency_3.spidex.erc20.v1.TokenPair[]) {
        ...
        static fromObject(data: {
            token_pairs?: ReturnType<typeof dependency_3.spidex.erc20.v1.TokenPair.prototype.toObject>[];
            ...
            if (data.token_pairs != null) {
                message.token_pairs = data.token_pairs.map(item => dependency_3.spidex.erc20.v1.TokenPair.fromObject(item));
            }
            if (data.pagination != null) {
        ...
        toObject() {
            ...
            if (this.token_pairs != null) {
                data.token_pairs = this.token_pairs.map((item: dependency_3.spidex.erc20.v1.TokenPair) => item.toObject());
            }
            if (this.pagination != null) {
                data.pagination = this.pagination.toObject();
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.token_pairs.length)
                writer.writeRepeatedMessage(1, this.token_pairs, (item: dependency_3.spidex.erc20.v1.TokenPair) => item.serialize(writer));
            if (this.has_pagination)
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryTokenPairsResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.token_pairs, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_3.spidex.erc20.v1.TokenPair.deserialize(reader), dependency_3.spidex.erc20.v1.TokenPair));
                        break;
                    case 2:
    ...
    export class QueryTokenPairResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            token_pair?: dependency_3.spidex.erc20.v1.TokenPair;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get token_pair() {
            return pb_1.Message.getWrapperField(this, dependency_3.spidex.erc20.v1.TokenPair, 1) as dependency_3.spidex.erc20.v1.TokenPair;
        }
        set token_pair(value: dependency_3.spidex.erc20.v1.TokenPair) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
        get has_token_pair() {
            return pb_1.Message.getField(this, 1) != null;
        ...
        static fromObject(data: {
            token_pair?: ReturnType<typeof dependency_3.spidex.erc20.v1.TokenPair.prototype.toObject>;
        }): QueryTokenPairResponse {
            const message = new QueryTokenPairResponse({});
            if (data.token_pair != null) {
                message.token_pair = dependency_3.spidex.erc20.v1.TokenPair.fromObject(data.token_pair);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryTokenPairResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.token_pair, () => message.token_pair = dependency_3.spidex.erc20.v1.TokenPair.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class QueryParamsResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            params?: dependency_2.spidex.erc20.v1.Params;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get params() {
            return pb_1.Message.getWrapperField(this, dependency_2.spidex.erc20.v1.Params, 1) as dependency_2.spidex.erc20.v1.Params;
        }
        set params(value: dependency_2.spidex.erc20.v1.Params) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
        get has_params() {
            return pb_1.Message.getField(this, 1) != null;
        ...
        static fromObject(data: {
            params?: ReturnType<typeof dependency_2.spidex.erc20.v1.Params.prototype.toObject>;
        }): QueryParamsResponse {
            const message = new QueryParamsResponse({});
            if (data.params != null) {
                message.params = dependency_2.spidex.erc20.v1.Params.fromObject(data.params);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryParamsResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.params, () => message.params = dependency_2.spidex.erc20.v1.Params.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
